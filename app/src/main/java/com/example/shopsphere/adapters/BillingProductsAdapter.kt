...
import com.example.shopsphere.databinding.BillingProductsRvItemBinding
...
class BillingProductsAdapter : Adapter<BillingProductsAdapter.BillingProductsViewHolder>() {
        ...
        fun bind(billingProduct: CartProduct) {
            binding.apply {
                ...
                imageCartProductColor.setImageDrawable(
                    ColorDrawable(
                        billingProduct.selectedColour ?: Color.TRANSPARENT
                    )
                )
    ...
    override fun onBindViewHolder(holder: BillingProductsViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            onBillingProductClick?.invoke(billingProduct)
        }
    }

    var onBillingProductClick: ((CartProduct) -> Unit)? = null
}